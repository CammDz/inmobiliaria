...
- **Tablero Scrum (Padlet):** https://padlet.com/dayroncamilo4/inmovain-soluciones-tablero-scrum-s023incmxbtuuuhomv53 (respaldo en `docs/tablero_padlet.html` y detalle en `docs/TABLERO_PADLET.md`).
