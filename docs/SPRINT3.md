...
## Sprint Review
- **Logros:** 8 reportes SQL documentados; auditoría completa con IP; siembra idempotente que arranca al desplegar; WAR/estructura lista para Tomcat; compilación de **64 clases Java** sin errores.
